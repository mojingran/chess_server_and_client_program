...
void pawnPromotion(){
 ...
 for(int c=0;c<8;c++){
  ...
  if(key=='Q'||key=='q'){
   grid[0][c]='q';
   myClient.write(0+","+c+","+"q");
 }else if(key=='N'||key=='n'){
   grid[0][c]='n';
   myClient.write(0+","+c+","+"n");
 }else if(key=='B'||key=='b'){
   grid[0][c]='b';
   myClient.write(0+","+c+","+"b");
 }else if(key=='R'||key=='r'){
   grid[0][c]='r';
   myClient.write(0+","+c+","+"r");
 }
   }
  }
  if(grid[7][c]=='P'){
  ...
  if(key=='Q'||key=='q'){
   grid[7][c]='Q';
   myClient.write(7+","+c+","+"Q");
 }else if(key=='N'||key=='n'){
   grid[7][c]='N';
   myClient.write(7+","+c+","+"N");
 }else if(key=='B'||key=='b'){
   grid[7][c]='B';
   myClient.write(7+","+c+","+"B");
 }else if(key=='R'||key=='r'){
   grid[7][c]='R';
   myClient.write(7+","+c+","+"R");
 }
  }
 }
 }
